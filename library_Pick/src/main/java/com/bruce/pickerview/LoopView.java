...
//        int left = paddingLeft;
        ...
        int left = (measuredWidth - maxTextWidth)/2;//qlt依据最长的一个条目居中,每个条目都居中,在下面赋值
        ...
        while (j1 < itemCount) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (gravity == Gravity.CENTER) {
                    paintB.getTextBounds(as[j1], 0, as[j1].length(), rect4TextWidth);
                    left = (measuredWidth - rect4TextWidth.width()) / 2;
                }
