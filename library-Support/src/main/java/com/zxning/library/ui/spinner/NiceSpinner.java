package com.zxning.library.ui.spinner;
...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        /*setPadding(resources.getDimensionPixelSize(R.dimen.three_grid_unit), defaultPadding, defaultPadding,
            defaultPadding);*/
        setPadding(0, defaultPadding, defaultPadding,
                defaultPadding);
        setClickable(true);
    ...
    public void setSelectedIndex(int position) {
        if (mAdapter != null) {
            if (position >= 0 && position <= mAdapter.getCount()) {
                ...
                throw new IllegalArgumentException("Position must be lower than com.jtoushou.mytooldemo.adapter count!");
            }
        }
    }
