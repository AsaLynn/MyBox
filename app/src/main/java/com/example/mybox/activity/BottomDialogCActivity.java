...
import com.example.mybox.bean.PickerViewData;
import com.example.mybox.bean.ProvinceBean;
...
public class BottomDialogCActivity extends BaseActivity {
    ...
    protected View initContentView() {
        View view = UIUtils.inflate(this, R.layout.activity_bottom_dialog4);
