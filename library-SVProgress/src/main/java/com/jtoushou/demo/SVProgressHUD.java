...
public class SVProgressHUD {
    ...
    private static final SVProgressHUD getInstance(Context context) {
        if (mSVProgressHUD == null) {
            ...
            mSVProgressHUD.initDefaultView();//1.
    ...
    public static void showWithMaskType(Context context, SVProgressHUDMaskType maskType) {
        ...
        getInstance(context).mSharedView.setBoxBackground(R.drawable.bg_svprogresshuddefault);
        getInstance(context).mSharedView.show();
        getInstance(context).svShow();
    }
    ...
    public static void showWithStatus(Context context, String string, int resid) {
        showWithStatus(context, string);
        getInstance(context).mSharedView.setBoxBackground(resid);//
        getInstance(context).svShow();
    }
    ...
    public static void showInfoWithStatus(Context context, String string, SVProgressHUDMaskType maskType, int resid) {
        getInstance(context).setMaskType(maskType);
        getInstance(context).mSharedView.showInfoWithStatus(string);
        getInstance(context).mSharedView.setBoxBackground(resid);
        getInstance(context).svShow();
    ...
    public static void showZhiWithStatus(Context context, String string, SVProgressHUDMaskType maskType, int resid) {
        getInstance(context).setMaskType(maskType);
        getInstance(context).mSharedView.showZhiWithStatus(string);
        getInstance(context).mSharedView.setBoxBackground(resid);
        getInstance(context).svShow();
    }
